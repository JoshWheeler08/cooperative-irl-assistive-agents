# Difference between Vanilla, Medium & Hard Skill Levels
    # - VANILLA: Default Setting, Speed of Archer's Arrows = 45
    # - MEDIUM: Archer's arrows are slower than Vanilla (Speed: 45 -> 35), so it can't provide as much assistance to the Knight
    # - HARD: Archer's arrows are even slower than Medium (Speed: 35 -> 25)

""" Code provided by PettingZoo for setting the skill level of the Knight, Archer and Zombie agents"""
