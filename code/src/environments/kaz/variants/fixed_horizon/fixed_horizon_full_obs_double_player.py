...
class FixedHorizonFullObsDoubleKAZ(FixedHorizonDoubleKAZ):
    """
        Fixed-horizon, double-player KAZ environment where the archer's per-step observation has been changed 
    ...
    def __init__(
        ...
        super(FixedHorizonFullObsDoubleKAZ, self).__init__(
    ...
    def reset(self, seed=None):
        ...
        if self.vector_state:
            ...
            obs_archer = self.observe(
                current_agent = self.archer, 
                full_obs=True,
            )
