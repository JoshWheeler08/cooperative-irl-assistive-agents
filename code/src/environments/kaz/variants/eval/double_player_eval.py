...
class EvalDoubleKAZ(DoubleKAZ):
    
    """ 
        Variable-horizon, double-player version of the KAZ environment where the knight's policy 
        is passed in to allow it to act autonomously. This environment is used for evaluating the overall game performance of both agents
        because it returns their collective reward per step, rather than just the Archer's like other KAZ implementations.
    """
    ...
    def __init__(
        ...
        super(EvalDoubleKAZ, self).__init__(
