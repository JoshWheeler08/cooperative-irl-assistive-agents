...
class EvalFixedHorizonFullObsDoubleKAZ(FixedHorizonFullObsDoubleKAZ):
    """ 
        ...
        GLOBAL observation per timestep.
    """
    ...
    def __init__(
        ...
        super(EvalFixedHorizonFullObsDoubleKAZ, self).__init__(
    ...
    def step(self, action):
        ...
        # Storing knight's observation for determining next action 
