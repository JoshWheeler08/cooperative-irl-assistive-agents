...
class MyAIRL(IRLImplementation):
    ...
    """ 
        AIRL implementation adapted from example code provided by the Imitation library to fit my IRL template.
    ...
    def train(self):
        """ Code adapted from https://imitation.readthedocs.io/en/latest/tutorials/4_train_airl.html"""
        ...
        learner = PPO( # these are the default SB3 PPO argument values
            env=venv,
            policy=MlpPolicy,
            batch_size=64,
            ent_coef=0.0,
        ...
        airl_trainer.train(self.args["total_timesteps"])  # Note: set to 300000 for better results
